...
const ReplyMaterialsContent: React.FC<ReplyMaterialsContentProps> = ({ activeConfig, onToggleSidebar }) => {
  ...
  const { data, isLoading, isFetching } = useGetReplyMaterialsQuery({ waba_id: waba_id || "", page, limit, search: searchTerm });
