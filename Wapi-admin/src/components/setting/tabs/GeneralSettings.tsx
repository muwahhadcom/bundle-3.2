    ...
    <div className="space-y-5">
      ...
      <SettingCard title="Preferences" description="Control application-wide behavior.">
        <div className="space-y-4">
          ...
          <SettingToggle label="Enable Cookie Preference Pop-up" description="Display a GDPR-compliant cookie consent preference banner on the landing pages." checked={settings.cookie_enabled ?? false} onCheckedChange={(v) => onChange("cookie_enabled", v)} disabled={isLoading} />
