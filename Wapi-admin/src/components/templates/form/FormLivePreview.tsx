    ...
    switch (platform) {
      ...
      case "instagram":
        return {
          ...
          avatarBg: "bg-gradient-to-tr from-[#fec564] via-[#fd5c63] to-[#d9317a]",
          title: "Your Brand",
      ...
      case "twitter":
        return {
          headerBg: "bg-white dark:bg-[#15202B] border-b border-slate-100 dark:border-[#38444D]",
          avatarBg: "bg-black dark:bg-white text-white dark:text-black",
          title: "Your Account",
          subtitle: "Twitter / X Business",
          textColor: "text-slate-900 dark:text-neutral-50",
          subColor: "text-slate-400 dark:text-neutral-500",
          arrowColor: "text-slate-800 dark:text-neutral-300",
        };
      ...
      default:
        return {
          headerBg: "bg-[#075e54] dark:bg-[#1f2c34]",
      ...
      <div className="w-full max-w-77.5 bg-neutral-900 rounded-[2.5rem] p-1 border border-neutral-800 shadow-2xl relative ring-1 ring-neutral-700/50">
        ...
        <div className="w-full h-full bg-whatsapp-chat-bg rounded-[2.2rem] overflow-hidden flex flex-col min-h-150 max-h-150">
          <div className={`${brandConfig.headerBg} p-4 pt-8 flex items-center gap-3 shrink-0 justify-between`}>
            <div className="flex items-center gap-2.5 min-w-0 flex-1">
              ...
              <div className={`w-8 h-8 rounded-full ${brandConfig.avatarBg} flex items-center justify-center overflow-hidden shrink-0`}>
                {platform === "twitter" ? (
                  <TwitterIcon size={16} className="text-white dark:text-black" />
                ) : (
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className={`text-[9.5px] font-medium leading-none mt-0.5 break-all whitespace-normal line-clamp-2 ${brandConfig.subColor}`}>{brandConfig.subtitle}</p>
              </div>
            </div>
          ...
          <TemplatePreviewBubble
            ...
            mediaButtonTemplates={mediaButtonTemplates}
            authData={authData}
            platform={platform}
          />
        </div>
