  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(buttonVariants({ variant: "outline" }), "h-8 w-8 bg-transparent p-0 opacity-60 hover:opacity-100 absolute left-1 top-1 z-10 rounded-lg border-slate-200 dark:border-(--card-border-color)"),
        button_next: cn(buttonVariants({ variant: "outline" }), "h-8 w-8 bg-transparent p-0 opacity-60 hover:opacity-100 absolute right-1 top-1 z-10 rounded-lg border-slate-200 dark:border-(--card-border-color)"),
