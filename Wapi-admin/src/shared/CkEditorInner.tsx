    ...
    Promise.all([
      ...
      ([
        ...
        setEditor({
          CKEditor,
          DecoupledEditor:
            DecoupledEditor as unknown as typeof DecoupledEditorType,
          plugins: [
            Essentials,
            Paragraph,
            Bold,
    ...
    >
      {editor ? (
        <>
          <div
            ref={toolbarRef}
            className="ck-toolbar-container border-b border-gray-100 dark:border-(--card-border-color) bg-gray-50/50 dark:bg-(--dark-sidebar) p-1"
          />
